...
* it may involve improving variable selection, creating or transforming variables (for example creating the ratio of some variables), at natural idea is to scale variables by the total asset as in [Altman Z-score](https://en.wikipedia.org/wiki/Altman_Z-score).
